			...
			if($getSum){
				while($sumRow = mysqli_fetch_array($getSum)){
					...
					if ($rating > 4.75){
						...
						$response.=  "<img height='25px;' src='images/4_5stars.png'>";
					} else if ($rating > 3.75){
						$response.=  "<img height='25px;' src='images/4stars.png'>";
					} else if ($rating > 3.25){
						$response.=  "<img height='25px;' src='images/3_5stars.png'>";
					} else if ($rating > 2.75){
						$response.=  "<img height='25px;' src='images/3stars.png'>";
					} else if ($rating > 2.25){
						$response.=  "<img height='25px;' src='images/2_5stars.png'>";
					} else if ($rating > 1.75){
						$response.=  "<img height='25px;' src='images/2stars.png'>";
					} else if ($rating > 1.25){
						$response.=  "<img height='25px;' src='images/1_5stars.png'>";
					} else if ($rating > 0.75){
						$response.=  "<img height='25px;' src='images/1stars.png'>";
					} else if ($rating > 0.25){
						$response.=  "<img height='25px;' src='images/0_5stars.png'>";
					} else {
